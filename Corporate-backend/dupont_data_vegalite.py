...
{{
  ...
  "mark": "line",
  "encoding": {{
    "x": {{"field": "年份", "type": "ordinal", "title": "Year"}},
    "y": {{"field": "值", "type": "quantitative", "title": "Value", "format": ".2%"}},
    "color": {{"field": "标签", "type": "nominal", "title": "Metric"}},
    "tooltip": [
      {{"field": "年份", "type": "ordinal", "title": "Year"}},
      {{"field": "标签", "type": "nominal", "title": "Metric"}},
